...
def sysml_to_ttl(
    ...
    """
    lines = [
        f'@prefix eng: <urn:eng:> .',
        f'@prefix sysml: <urn:sysml:> .',
        '',
        f'# SysML v2 model data (translated from SysML API)',
        f'# Source package: {package}',
        f'# Loaded at: {datetime.now(timezone.utc).isoformat()}',
        '',
...
def requirements_to_ttl(
    ...
    lines = [
        ...
        '@prefix dt:  <urn:dt:> .',
        '',
        f'# Requirements (translated from requirements management tool)',
        f'# Document: {document}',
        '',
